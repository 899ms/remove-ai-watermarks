...
def remove_visible(
    ...
    *,
    ...
    The registry covers the marks listed by ``known_marks()``: the Gemini visible
    watermark, vendor text marks, the brand-less ``AI生成`` label, pills and badges.
    Returns ``(result_bgr, [labels removed])``.
